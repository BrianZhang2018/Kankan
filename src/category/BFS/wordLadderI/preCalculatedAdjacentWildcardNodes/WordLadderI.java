 ...
 * linkedIn 高频
 * Problem: BFS traverse graph + wildcard word dictionary
 *
 * undirected and unweighted graph with words as nodes and edges between words which differ by just "one letter".
 ...
 *
 * Time Complexity: O(N*L), L is the length of each word and N is the
 * total number of words in the input word list.
 * check the detailed analysis from below code for time complexity
 *
 * Example wildcard adjacency dictionary output (for wordList = ["hot", "dot", "dog", "lot", "log", "cog"]):
 *   *ot -> [hot, dot, lot]
 *   h*t -> [hot]
 *   ho* -> [hot]
 *   d*t -> [dot]
...
public class WordLadderI {
    ...
    public static int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        // length of each word, M=(N*L) is constant since it's pre-calculated in above, so can be ignored.
